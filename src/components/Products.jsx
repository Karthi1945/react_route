...
const Products = () => {
  ...
  // ===================fetch products===============
    ...
    fetchData('products').then(
     ...
     console.log('export_data_fetched',fetchData('products'))
    )
  ...
  const handelSoldProducts = (e) => { e.persist()
    console.log("cliked_value",handelSoldProducts)
    ...
    const newProducts = {
      ...
      console.log("addedcart",soldProduct);
      console.log('export_data_fetched',fetchData('products'))
