    ...
    <Box sx={{width:'100%',height:'90vh',py:3,display:'flex',alignItems:'center',justifyContent:'center',gap:2,flexDirection:'column'}}>
      {rows.length > 0 ?
        <>
          ...
          <Typography variant='h5'>10% discount rate {res-(res*.1)} INR</Typography>
              ...
              <TableBody>
                {rows.map((row) => (
                  <StyledTableRow key={row.id}>
                    ...
                    <StyledTableCell align="center">{row.price} INR</StyledTableCell>
                    <StyledTableCell align="center">{row.res?row.res : row.price} INR</StyledTableCell>
